...
const columnHelper = createColumnHelper<TradeWithJoins>();
...
export default function TradeTable({ trades }: { trades: TradeWithJoins[] }) {
  ...
  const [selectedTrade, setSelectedTrade] = useState<TradeWithJoins | null>(
    null,
  );
  ...
  function handleRowClick(trade: TradeWithJoins) {
