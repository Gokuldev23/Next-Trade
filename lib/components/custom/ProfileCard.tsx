...
export default function ProfileCard({ userPromise }: ProfileCardProps) {
    ...
    const [state,action,isSaving] = useActionState(editProfileAction,null)
                ...
                <CardHeader className="text-center pb-6">
                    <div className="flex justify-center mb-4">
                        <Avatar className="h-24 w-24 border-4 border-white shadow-md">
                            <AvatarImage width={100} height={100} className=' object-cover' src={user.profile_image_url || ""} alt={user.name} />
                    ...
                    <div className="mt-2">
                        <Badge variant={user.is_active ? "default" : "secondary"} className="text-sm">
                ...
                <CardContent className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            ...
                            <p className="text-sm text-slate-600 p-2 bg-slate-50 rounded-md">{user.id}</p>
                        </div>
                    ...
                    <div className="pt-4 border-t border-slate-200">
                        <h3 className="font-semibold text-slate-700 mb-3">Account Actions</h3>
                        <div className="flex flex-wrap gap-3">
                            ...
                            <Button variant="outline" className="text-rose-700 border-rose-200 hover:bg-rose-50">
                                Deactivate Account
                            </Button>
                        </div>
                    </div>
            ...
            <Dialog open={isEditModalOpen} onOpenChange={setIsEditModalOpen}>
                <DialogContent className="sm:max-w-[500px]">
                    ...
                    <Form action={action} className="grid gap-4 pt-4">
                        <div>
                            <input type="text" name='userId' readOnly value={user.id} hidden />
                        </div>
                        <div className="">
                            ...
                            <Input name='profile_image_file' id="profile_image_file" type="file" hidden />
                        </div>
