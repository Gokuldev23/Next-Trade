      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        ...
        <Card className="lg:col-span-3">
          <CardHeader>
            ...
            <CardDescription>You made 26 trades this month.</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="flex items-center">
                  <div
                    className={`size-9 rounded-full flex items-center justify-center border ${trade.status === "success" ? "bg-success/10 border-success/20 text-success" : "bg-destructive/10 border-destructive/20 text-destructive"}`}
                  >
                  ...
                  <div
                    className={`ml-auto font-medium ${trade.status === "success" ? "text-success" : "text-destructive"}`}
                  >
                    {trade.amount}
                  </div>
                </div>
