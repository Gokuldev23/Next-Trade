        ...
        <main className="flex min-h-screen items-center justify-center px-4">
            <section className="w-full max-w-md rounded-2xl bg-neutral-900  shadow-lg p-8">
                ...
                <form action="/api/auth/login" method="POST" className="space-y-5">
                    ...
                    <button
                        type="submit"
                        className="w-full rounded-lg bg-white text-slate-600 px-4 py-2  font-medium shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-1 transition"
                    >
                        Sign in
                    </button>
                </form>
